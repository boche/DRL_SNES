...
def main():  # noqa: D103
    ...
    parser.add_argument('--save_freq', default=500000, type=int, help='The frequency with which the network is saved')
    parser.add_argument('--eval_freq', default=40000, type=int, help='The frequency with which the policy is evlauted')    
